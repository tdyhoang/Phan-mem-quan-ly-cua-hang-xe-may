...
public partial class QlychbanxemayContext : DbContext
{
    public QlychbanxemayContext()
    {
    }

    public QlychbanxemayContext(DbContextOptions<QlychbanxemayContext> options)
        : base(options)
    {
    }
